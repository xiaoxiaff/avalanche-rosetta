...
var (
	...
	// Export Tx
	exportInputData = compact(`[
		{"OperationIdentifier":{"index":0},"AccountIdentifier":{"address":"0x3158e80abD5A1e1aa716003C9Db096792C379621"}},
		{"OperationIdentifier":{"index":1},"AccountIdentifier":{"address":"P-fuji1wmd9dfrqpud6daq0cde47u0r7pkrr46ep60399"}}
	]`)
	unsignedExportTx = compact(`
		
		71e3f06c31d7590000000024739402
	`)
	wrappedUnsignedExportTx    = `{"tx":"` + unsignedExportTx + `","signers":` + exportInputData + `}`
	...
	signedExportTx = compact(`
		
	`)
	wrappedSignedExportTx = `{"tx":"` + signedExportTx + `","signers":` + exportInputData + `}`

	// Import Tx
	importInputData = compact(`[
		{"OperationIdentifier":{"index":0},"AccountIdentifier":{"address":"P-fuji1wmd9dfrqpud6daq0cde47u0r7pkrr46ep60399"}},
		{"OperationIdentifier":{"index":1},"AccountIdentifier":{"address":"P-fuji1wmd9dfrqpud6daq0cde47u0r7pkrr46ep60399"}},
		{"OperationIdentifier":{"index":2},"AccountIdentifier":{"address":"0x3158e80abD5A1e1aa716003C9Db096792C379621"}}
	]`)
	unsignedImportTx = compact(`
		
	`)
	wrappedUnsignedImportTx    = `{"tx":"` + unsignedImportTx + `","signers":` + importInputData + `}`
	...
	signedImportTx = compact(`
		
		236db8dbb419e264628e2f17330a6c8da60d342401dc68b1fc
	`)
	wrappedSignedImportTx = `{"tx":"` + signedImportTx + `","signers":` + importInputData + `}`
...
func TestConstructionParse(t *testing.T) {
	...
	t.Run("C-chain export signed parse", func(t *testing.T) {
		...
		assert.Nil(t, apiErr)
		assert.Equal(t, []*types.AccountIdentifier{cAccountIdentifier, pAccountIdentifier}, resp.AccountIdentifierSigners)
		assert.Equal(t, exportOperations, resp.Operations)
	})
	...
	t.Run("C-chain import signed parse", func(t *testing.T) {
		...
		assert.Nil(t, apiErr)
		assert.Equal(t, []*types.AccountIdentifier{pAccountIdentifier, pAccountIdentifier, cAccountIdentifier}, resp.AccountIdentifierSigners)
		assert.Equal(t, importOperations, resp.Operations)
	})
}
